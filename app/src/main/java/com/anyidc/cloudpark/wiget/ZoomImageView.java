...
public class ZoomImageView extends AppCompatImageView {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (event.getPointerCount() == 1) {
                    ...
                    // 进行缩放倍数检查，最大只允许将图片放大10倍，最小可以缩小到初始化比例
    ...
    private void zoom() {
        ...
        float scaledWidth = drawable.getIntrinsicWidth() * totalRatio;
        float scaledHeight = drawable.getIntrinsicHeight() * totalRatio;
        float translateX = 0f;
        float translateY = 0f;
    ...
    private void initBitmap(Canvas canvas) {
        ...
        matrix.reset();
        int bitmapWidth = d.getIntrinsicWidth();
        int bitmapHeight = d.getIntrinsicHeight();
